    ...
    public static void setUp() throws Exception {
        ...
        HttpRouter authRouter = Http.router()
                .use("/basic", Http.router()
                    .use(Authentication.basic("Basic_Authentication_Realm", new CredentialProvider() {
                        @Override
                        ...
                        .use(Authentication.digest("Digest_Authentication_Realm", new CredentialProvider() {
                            @Override
                            public Credentials findByUsername(String username) {
                                return new Credentials("felix", "test");
                            }
